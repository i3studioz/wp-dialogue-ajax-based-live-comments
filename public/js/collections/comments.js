    ...
    actionURL: function (method, old_start, new_start, read_post, read_type) {
        ...
        switch (method) {
            case 'read':
                ...
                return 'http://localhost/live-comments/wp-admin/admin-ajax.php?action=fetch_comment&post_id=' + read_post + '&old_start=' + old_start + '&new_start=' + new_start + '&type=' + read_type;
